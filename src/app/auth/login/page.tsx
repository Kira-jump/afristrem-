...
export default function LoginPage() {
  ...
  async function onSubmit(e: React.FormEvent) {
    ...
    setLoading(false);
    if (res?.error) setError("Email ou mot de passe invalide.");
  ...
  return (
    <div className="grid min-h-screen md:grid-cols-2">
      <div className="relative hidden bg-gradient-to-br from-forest-900 via-bg to-bg md:block">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1485846234645-a62644f84728?w=1600&q=80')] bg-cover bg-center opacity-30" />
        <div className="absolute inset-0 bg-gradient-to-tr from-bg via-bg/40 to-transparent" />
        <div className="relative flex h-full flex-col justify-between p-10">
          <Logo />
          <div>
            <h2 className="font-display text-4xl font-bold leading-tight">
              <span className="text-gold-gradient">Bienvenue</span>
              <br />
              dans la plus grande<br />cinémathèque africaine.
            </h2>
            <p className="mt-4 max-w-md text-white/70">
              Films, séries, documentaires — du Sénégal au Caire, de Lagos à Kigali.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center justify-center px-6 py-16 sm:px-12">
        <div className="w-full max-w-sm">
          ...
          <h1 className="mt-8 font-display text-3xl font-semibold md:mt-0">Connexion</h1>
